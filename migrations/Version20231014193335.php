 ...
 */
final class Version20231014193335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answer (id INT AUTO_INCREMENT NOT NULL, situation_id INT DEFAULT NULL, content LONGTEXT NOT NULL, valid TINYINT(1) NOT NULL, INDEX IDX_DADD4A253408E8AF (situation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE proposition (id INT AUTO_INCREMENT NOT NULL, situation_id INT NOT NULL, answer_id INT NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_C7CDC3533408E8AF (situation_id), UNIQUE INDEX UNIQ_C7CDC353AA334807 (answer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE situation (id INT AUTO_INCREMENT NOT NULL, question LONGTEXT NOT NULL, explanation LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE answer ADD CONSTRAINT FK_DADD4A253408E8AF FOREIGN KEY (situation_id) REFERENCES situation (id)');
        $this->addSql('ALTER TABLE proposition ADD CONSTRAINT FK_C7CDC3533408E8AF FOREIGN KEY (situation_id) REFERENCES situation (id)');
        $this->addSql('ALTER TABLE proposition ADD CONSTRAINT FK_C7CDC353AA334807 FOREIGN KEY (answer_id) REFERENCES answer (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer DROP FOREIGN KEY FK_DADD4A253408E8AF');
        $this->addSql('ALTER TABLE proposition DROP FOREIGN KEY FK_C7CDC3533408E8AF');
        $this->addSql('ALTER TABLE proposition DROP FOREIGN KEY FK_C7CDC353AA334807');
